...
export default function EditMenuForm(params: Params) {
    ...
    const [minStartDate, setMinStartDate] = useState(getFormattedDateForDateSelect(new Date(params.activationDate)));
    const [minEndDate, setMinEndDate] = useState(getFormattedDateForDateSelect(new Date(params.activationDate)));
